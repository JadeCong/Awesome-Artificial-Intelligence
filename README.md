...
>> 7. Episodic Meta Reinforcement Learning
>> 8. Few-Shot Imitation Learning
>> 9. Model-Agnostice Meta Learning
>> 10. Imitation Learning（Behavior Cloning/Inverse Reinforcement Learning/GAN Method/Interaction & Active Learning）
...
>>（4）调整模型：可选项，对感兴趣任务的调整输入-输出配对数据或者改进模型。
>
> 2. 预训练模型方法（三步）：
>
